...
firebase = firebase.FirebaseApplication("https://encrypt-decrept-default-rtdb.firebaseio.com", None)
...
def enterRoom():
    ...
    message_window.geometry("598x500")
...
youe_code_entry.place(relx=0.6,rely=0.5, anchor=CENTER)
